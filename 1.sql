...
CREATE TABLE `class_plan` (
  ...
  `plan_type` varchar(50) DEFAULT NULL COMMENT '运动类型',
  `grade` varchar(20) DEFAULT NULL COMMENT '适用年级',
  `avatar` varchar(255) DEFAULT NULL COMMENT '封面图片地址',
  `content` text COMMENT '教案内容',
  `people_count` int DEFAULT '0' COMMENT '适用人数',
  `views` int DEFAULT '0' COMMENT '观看次数',
  `downloads` int DEFAULT '0' COMMENT '下载次数',
  `rating` decimal(3,1) DEFAULT '0.0' COMMENT '平均评分',
  `rate_count` int DEFAULT '0' COMMENT '评分人数',
  `note1` text COMMENT '教学目标',
  `note2` text COMMENT '教学过程',
  `note3` varchar(255) DEFAULT NULL COMMENT '备用字段',
  ...
  PRIMARY KEY (`plan_id`)
) ENGINE=InnoDB AUTO_INCREMENT=103 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='教案管理表';
...
INSERT INTO `class_plan` VALUES (100,'篮球基础教学','篮球',NULL,NULL,'适合初学者的篮球基础教学计划',0,0,0,0.0,0,'掌握篮球的基本规则和技巧，包括运球、传球和投篮等基本动作。','1. 热身运动（5分钟）\n2. 基本姿势讲解（10分钟）\n3. 运球练习（15分钟）\n4. 传球技巧（15分钟）\n5. 投篮基础（20分钟）\n6. 小组对抗（15分钟）\n7. 总结与拉伸（10分钟）',NULL,'','2025-04-17 20:51:08','','2025-04-17 22:27:35',NULL),(101,'足球战术训练','足球',NULL,NULL,'针对进阶学员的足球战术训练计划',0,0,0,0.0,0,'提高学生的团队配合能力和战术意识，掌握基本的攻防转换和位置配合。','1. 热身与基础传球（10分钟）\n2. 战术理论讲解（15分钟）\n3. 小组配合训练（20分钟）\n4. 攻防转换演练（20分钟）\n5. 实战应用（25分钟）\n6. 放松整理（10分钟）',NULL,'','2025-04-17 20:51:08','',NULL,NULL),(102,'排球基础技巧','排球',NULL,NULL,'大学生排球入门教学',1,0,0,0.0,0,'掌握排球发球、垫球、传球等基本技术，了解比赛规则和基本战术。','1. 准备活动与热身（10分钟）\n2. 基本手型与姿势（10分钟）\n3. 垫球技术练习（15分钟）\n4. 传球技术练习（15分钟）\n5. 发球技术（15分钟）\n6. 简易比赛（20分钟）\n7. 总结与放松（5分钟）',NULL,'','2025-04-17 20:51:08','','2025-04-17 22:28:56',NULL);
/*!40000 ALTER TABLE `class_plan` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `class_plan_rating`
--

DROP TABLE IF EXISTS `class_plan_rating`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `class_plan_rating` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `plan_id` bigint NOT NULL COMMENT '教案ID',
  `user_id` bigint NOT NULL COMMENT '用户ID',
  `score` int NOT NULL COMMENT '评分(1-5)',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '评分时间',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_user_plan` (`user_id`,`plan_id`) COMMENT '每个用户对每个教案只能评分一次'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='教案评分记录表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `class_plan_rating`
--

LOCK TABLES `class_plan_rating` WRITE;
/*!40000 ALTER TABLE `class_plan_rating` DISABLE KEYS */;
/*!40000 ALTER TABLE `class_plan_rating` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `istm_class` (
  ...
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  `remark` varchar(500) DEFAULT NULL COMMENT '备注',
  `class_desc` varchar(500) DEFAULT NULL COMMENT '教学目标',
  `plan_info` text COMMENT '教学过程',
  PRIMARY KEY (`class_id`)
) ENGINE=InnoDB AUTO_INCREMENT=107 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='课程表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `istm_class` VALUES (103,'篮球基础训练','5','运球\n传球\n投篮\n','训练篮球基本功',0,30,0,45,'','','','','2025-04-17 16:30:32','','2025-04-17 19:28:40','训练篮球基本功',NULL,NULL),(104,'足球基本训练','1','颠球\n传球\n盘带过人\n射门','训练足球基本功',0,30,0,45,'','','','','2025-04-17 16:41:20','','2025-04-17 19:33:38','训练足球基本功',NULL,NULL),(105,'武术基础教学','2','跑步热身，活动基本关节\n压腿、踢腿等柔韧性练习\n冲拳、推掌教学','学习一些武术基本动作',0,30,0,45,'','','','','2025-04-17 18:19:46','','2025-04-17 19:35:10','学习一些武术基本动作',NULL,NULL),(106,'排球练习','0','发球教学\n垫球练习\n比赛实践','使学生熟练掌握排球基本技术，包括发球、垫球、传球、扣球、拦网等',0,30,0,45,'','','','','2025-04-17 19:37:55','','2025-04-17 21:44:51','使学生熟练掌握排球基本技术，包括发球、垫球、传球、扣球、拦网等',NULL,NULL);
...
INSERT INTO `sys_dict_type` VALUES (1,'用户性别','sys_user_sex','0','admin','2025-02-06 20:48:50','',NULL,'用户性别列表'),(2,'菜单状态','sys_show_hide','0','admin','2025-02-06 20:48:50','',NULL,'菜单状态列表'),(3,'系统开关','sys_normal_disable','0','admin','2025-02-06 20:48:50','',NULL,'系统开关列表'),(4,'任务状态','sys_job_status','0','admin','2025-02-06 20:48:50','',NULL,'任务状态列表'),(5,'任务分组','sys_job_group','0','admin','2025-02-06 20:48:50','',NULL,'任务分组列表'),(6,'系统是否','sys_yes_no','0','admin','2025-02-06 20:48:50','',NULL,'系统是否列表'),(7,'通知类型','sys_notice_type','0','admin','2025-02-06 20:48:50','',NULL,'通知类型列表'),(8,'通知状态','sys_notice_status','0','admin','2025-02-06 20:48:50','',NULL,'通知状态列表'),(9,'操作类型','sys_oper_type','0','admin','2025-02-06 20:48:50','',NULL,'操作类型列表'),(10,'系统状态','sys_common_status','0','admin','2025-02-06 20:48:50','',NULL,'登录状态列表'),(100,'课堂类型','sys_class_type','0','admin','2025-04-17 16:21:49','',NULL,'课堂类型列表');
...
INSERT INTO `sys_logininfor` VALUES (100,'admin','127.0.0.1','内网IP','Chrome 12','Windows 10','0','登录成功','2025-02-07 11:03:33'),(101,'admin','127.0.0.1','内网IP','Chrome 12','Windows 10','0','登录成功','2025-02-09 11:14:50'),(102,'admin','127.0.0.1','内网IP','Chrome 12','Windows 10','0','登录成功','2025-02-13 10:09:42'),(103,'admin','127.0.0.1','内网IP','Chrome 12','Windows 10','0','登录成功','2025-02-13 20:47:53'),(104,'admin','127.0.0.1','内网IP','Chrome 12','Windows 10','1','验证码错误','2025-02-14 08:01:48'),(105,'admin','127.0.0.1','内网IP','Chrome 12','Windows 10','0','登录成功','2025-02-14 08:01:51'),(106,'admin','127.0.0.1','内网IP','Chrome 12','Windows 10','1','验证码错误','2025-02-22 12:36:46'),(107,'admin','127.0.0.1','内网IP','Chrome 12','Windows 10','0','登录成功','2025-02-22 12:36:48'),(108,'admin','127.0.0.1','内网IP','Chrome 12','Windows 10','0','登录成功','2025-02-23 12:41:02'),(109,'admin','127.0.0.1','内网IP','Chrome 13','Windows 10','1','验证码错误','2025-04-17 15:34:16'),(110,'admin','127.0.0.1','内网IP','Chrome 13','Windows 10','0','登录成功','2025-04-17 15:49:56'),(111,'admin','127.0.0.1','内网IP','Chrome 13','Windows 10','1','验证码错误','2025-04-17 15:50:01'),(112,'admin','127.0.0.1','内网IP','Chrome 13','Windows 10','1','验证码错误','2025-04-17 15:50:05'),(113,'admin','127.0.0.1','内网IP','Chrome 13','Windows 10','0','登录成功','2025-04-17 15:50:08'),(114,'admin','127.0.0.1','内网IP','Chrome 13','Windows 10','1','验证码错误','2025-04-17 15:50:18'),(115,'admin','127.0.0.1','内网IP','Chrome 13','Windows 10','1','用户不存在/密码错误','2025-04-17 15:50:21'),(116,'admin','127.0.0.1','内网IP','Chrome 13','Windows 10','0','登录成功','2025-04-17 15:55:48'),(117,'admin','127.0.0.1','内网IP','Chrome 13','Windows 10','0','退出成功','2025-04-17 15:57:40'),(118,'admin','127.0.0.1','内网IP','Chrome 13','Windows 10','0','登录成功','2025-04-17 15:57:48'),(119,'admin','127.0.0.1','内网IP','Chrome 13','Windows 10','0','登录成功','2025-04-17 18:18:31'),(120,'admin','127.0.0.1','内网IP','Chrome 13','Windows 10','0','登录成功','2025-04-17 19:19:31'),(121,'admin','127.0.0.1','内网IP','Chrome 13','Windows 10','0','登录成功','2025-04-17 20:35:38'),(122,'admin','127.0.0.1','内网IP','Chrome 13','Windows 10','0','退出成功','2025-04-17 20:40:18'),(123,'admin','127.0.0.1','内网IP','Chrome 13','Windows 10','0','登录成功','2025-04-17 20:40:26'),(124,'admin','127.0.0.1','内网IP','Chrome 13','Windows 10','0','登录成功','2025-04-17 21:17:06'),(125,'admin','127.0.0.1','内网IP','Chrome 13','Windows 10','0','退出成功','2025-04-17 21:36:55'),(126,'admin','127.0.0.1','内网IP','Chrome 13','Windows 10','0','登录成功','2025-04-17 21:37:03'),(127,'admin','127.0.0.1','内网IP','Chrome 13','Windows 10','0','退出成功','2025-04-17 21:52:45'),(128,'admin','127.0.0.1','内网IP','Chrome 13','Windows 10','0','登录成功','2025-04-17 21:52:53'),(129,'admin','127.0.0.1','内网IP','Chrome 13','Windows 10','1','验证码错误','2025-04-17 22:27:24'),(130,'admin','127.0.0.1','内网IP','Chrome 13','Windows 10','0','登录成功','2025-04-17 22:27:27');
...
-- Dump completed on 2025-04-17 22:46:54

...
CREATE TABLE `class_plan` (
  ...
  `plan_name` varchar(255) NOT NULL COMMENT '教案名称',
  `plan_type` varchar(50) DEFAULT NULL COMMENT '运动类型',
  `plan_desc` text COMMENT '教案简介',
  `plan_purpose` text COMMENT '教学目标',
  `plan_process` text COMMENT '教学过程',
...
) ENGINE=InnoDB AUTO_INCREMENT=105 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='教案管理表';
...
INSERT INTO `class_plan` VALUES (100,'篮球基础教学','篮球','适合初学者的篮球基础教学计划','通过本课程，学生能够掌握篮球的基本规则和技巧，包括运球、传球和投篮等基本动作。','1. 热身运动（5分钟）\n2. 基本姿势讲解（10分钟）\n3. 运球练习（15分钟）\n4. 传球技巧（15分钟）\n5. 投篮基础（20分钟）\n6. 小组对抗（15分钟）\n7. 总结与拉伸（10分钟）',NULL,10,5,0.0,0,'','2025-04-17 20:38:28','',NULL,NULL),(101,'足球战术训练','足球','针对进阶学员的足球战术训练计划','提高学生的团队配合能力和战术意识，掌握基本的攻防转换和位置配合。','1. 热身与基础传球（10分钟）\n2. 战术理论讲解（15分钟）\n3. 小组配合训练（20分钟）\n4. 攻防转换演练（20分钟）\n5. 实战应用（25分钟）\n6. 放松整理（10分钟）',NULL,8,3,0.0,0,'','2025-04-17 20:38:28','',NULL,NULL),(102,'排球基础技巧','排球','大学生排球入门教学','掌握排球发球、垫球、传球等基本技术，了解比赛规则和基本战术。','1. 准备活动与热身（10分钟）\n2. 基本手型与姿势（10分钟）\n3. 垫球技术练习（15分钟）\n4. 传球技术练习（15分钟）\n5. 发球技术（15分钟）\n6. 简易比赛（20分钟）\n7. 总结与放松（5分钟）',NULL,12,6,0.0,0,'','2025-04-17 20:38:28','',NULL,NULL),(103,'田径跑步训练','田径','中长跑技巧与训练方法','提高学生的耐力和跑步技术，掌握正确的呼吸方法和姿势。','1. 热身（10分钟）\n2. 姿势纠正（15分钟）\n3. 间歇训练（20分钟）\n4. 持续跑（15分钟）\n5. 冲刺练习（10分钟）\n6. 拉伸放松（10分钟）',NULL,15,8,0.0,0,'','2025-04-17 20:38:28','',NULL,NULL),(104,'体操基础训练','体操','初级体操训练计划','培养学生的柔韧性、协调性和平衡能力，掌握基本体操动作。','1. 全身热身（10分钟）\n2. 柔韧性练习（15分钟）\n3. 基本姿势训练（15分钟）\n4. 前滚翻和后滚翻（20分钟）\n5. 平衡训练（15分钟）\n6. 整理放松（5分钟）',NULL,7,4,0.0,0,'','2025-04-17 20:38:28','',NULL,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=168 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='操作日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-04-17 20:45:36
